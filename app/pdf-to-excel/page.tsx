...
export default function PdfToExcelLandingPage() {
      ...
      <section className="border-b border-border bg-card px-4 py-16 sm:px-6 lg:px-8 text-center">
        <div className="mx-auto max-w-3xl space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            Extract data and tables from your PDF files into editable Excel spreadsheets.
          ...
          {isAuthenticated ? (
            ...
            <div className="rounded-2xl border border-border bg-card p-2 shadow-xl sm:p-4">
              <Suspense fallback={<div className="p-8 text-center">Loading...</div>}>
                <ConvertTool isGuest={true} initialType="pdf-to-xlsx" />
              </Suspense>
            </div>
          )}
        </div>
      ...
      <section className="border-t border-border px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl space-y-12">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold">How to convert PDF to Excel</h2>
            <ol className="list-inside list-decimal space-y-2 text-muted-foreground">
              <li>Upload your PDF file containing tabular data.</li>
              <li>Wait for the secure conversion to finish.</li>
              <li>Download your newly created Excel spreadsheet (XLSX).</li>
            </ol>
          </div>
        </div>
      </section>
