...
export default function PdfToPptxLandingPage() {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-border bg-card px-4 py-16 sm:px-6 lg:px-8 text-center">
        <div className="mx-auto max-w-3xl space-y-6">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 shadow-lg">
          ...
          <p className="text-lg text-muted-foreground">
            Turn your PDF presentations back into editable PowerPoint slides (PPTX).
            Maintain layouts, graphics, and text flawlessly.
          </p>
        </div>
      </section>
          ...
          {isAuthenticated ? (
            ...
            <div className="rounded-2xl border border-border bg-card p-2 shadow-xl sm:p-4">
              <Suspense fallback={<div className="p-8 text-center">Loading...</div>}>
                <ConvertTool isGuest={true} initialType="pdf-to-pptx" />
              </Suspense>
            </div>
          )}
        </div>
      ...
      <section className="border-t border-border px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl space-y-12">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold">How to convert PDF to PowerPoint</h2>
            <ol className="list-inside list-decimal space-y-2 text-muted-foreground">
              <li>Upload your PDF presentation.</li>
              <li>Wait for the secure conversion to finish.</li>
              <li>Download your fully editable PowerPoint presentation (PPTX).</li>
            </ol>
          </div>
        </div>
      </section>
